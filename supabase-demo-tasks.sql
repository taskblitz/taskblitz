-- Demo Tasks for TaskBlitz Marketplace
-- Run this in Supabase SQL Editor to populate with interesting tasks

-- First, create a demo user (the requester for all tasks)
...
DECLARE
  demo_user_id UUID;
BEGIN
  SELECT id INTO demo_user_id FROM users WHERE wallet_address = 'DemoWa11et1111111111111111111111111111111';
...
SELECT COUNT(*) as total_demo_tasks FROM tasks WHERE requester_id IN (
  SELECT id FROM users WHERE wallet_address = 'DemoWa11et1111111111111111111111111111111'
);
